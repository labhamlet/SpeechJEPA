...
def train_librilight(pretrained_jepa_model, 
                     ...
                     test_data_root,
                     manifest_dir,
                     use_kernel_dropout_encoder,
                     use_kernel_dropout_decoder,
                     with_decoder):
    ...
    model = SpeechJEPAForCTC(
        ...
        use_kernel_dropout_encoder=use_kernel_dropout_encoder, 
        use_kernel_dropout_decoder=use_kernel_dropout_decoder
    )
...
if __name__ == "__main__":
    ...
    is_asr_jepa = str(sys.argv[2]) == "True" 
    use_encoder_rope = str(sys.argv[3]) == "True" 
    use_decoder_rope = str(sys.argv[4]) == "True" 
    use_kernel_dropout_encoder = str(sys.argv[5]) == "True" 
    use_kernel_dropout_decoder = str(sys.argv[6]) == "True" 
    use_decoder_for_asr = str(sys.argv[7]) == "True" 
    ...
    model = JEPA(
                ...
                resample_sr=16000,
                size="base",
                use_decoder_rope=use_decoder_rope,
                use_encoder_rope=use_encoder_rope,
                use_kernel_dropout_encoder=use_kernel_dropout_encoder,
                use_kernel_dropout_decoder=use_kernel_dropout_decoder,
                **decoder_cfgs
            )
